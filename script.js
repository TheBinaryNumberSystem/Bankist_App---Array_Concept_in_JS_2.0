...
const formatMovementDate = function (date, locale) {
  ...
  // const month = `${date.getMonth() + 1}`.padStart(2, 0); //zero based index
...
// labelDate.textContent = new Intl.DateTimeFormat(local, options).format(timeNow);
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    // const month = `${timeNow.getMonth() + 1}`.padStart(2, 0); //zero based index
    // const year = timeNow.getFullYear();
    // const hours = `${timeNow.getHours()}`.padStart(2, 0);
    // const minutes = `${timeNow.getMinutes()}`.padStart(2, 0);
    // // balance__date.textContent = `${day}/${month}/${year}, ${hours}:${minutes}`;
...
// const calDaysPassed = (date1, date2) =>
//   Math.abs((date2 - date1) / (1000 * 60 * 60 * 24));
// console.log(calDaysPassed(new Date(2023, 6, 4), new Date(2022, 6, 4)));
